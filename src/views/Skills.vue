<template>
    <div class="skills">
        ...
        <p class="second-header" data-aos="fade-right">Main expertise</p>
        ...
        <p class="second-header" data-aos="fade-right">College experience</p>       
        ...
        <p class="second-header" data-aos="fade-right">Development environments</p>  
        ...
        <p class="second-header" data-aos="fade-right">Database</p>  
        <div class="databases">
            <div class="item" data-aos="fade-left">
